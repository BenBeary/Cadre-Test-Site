...
/announcements-and-events/     listing page + post templates
/css/                          stylesheets
...
A post is two things: an HTML file in /announcements-and-events/ and an entry
...
1. Pick the closest template in /announcements-and-events/ and copy it:
...
4. Open /json/blog-data.json and add an entry to the appropriate array:
   ...
   Required fields:
     "href"      path from the repo root, e.g.
                   "announcements-and-events/spring-mixer-recap.html"
   ...
   Example entry:
       ...
       {
           "href": "announcements-and-events/spring-mixer-recap.html",
...
Things to know:
    - {{root}} inside the template gets replaced with the path back to the
      ...
      they work from both / and /announcements-and-events/.
...
Notes:
    - The href path is relative to the page using it. From the root use
      "images/misc/...", from /announcements-and-events/ use "../images/misc/...".
...
- Path prefixes:
    ...
    /announcements-and-events/ pages:            "../images/..." / "../css/..."
